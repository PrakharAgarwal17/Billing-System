...
export default function SignUp() {
  ...
  const handleAction = (e) => {
    e.preventDefault();
    console.log("Registering Profile Terminal...", formData);
  };

  return (
    <form onSubmit={handleAction} className="space-y-4">
      <div className="space-y-1.5">
        <label className="text-xs font-medium text-zinc-400">Operator Identity</label>
      ...
      <div className="space-y-1.5">
        <label className="text-xs font-medium text-zinc-400">Communication Node</label>
        <div className="relative">
      ...
      <div className="space-y-1.5">
        <label className="text-xs font-medium text-zinc-400">Root Password</label>
        <div className="relative">
