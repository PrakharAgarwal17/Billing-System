...
import {lowquantityalert} from "../../controllers/ProductController/ProductController.js"
...
router.post("/lowquantityalert/:shopId/:orderId",isloggedin, lowquantityalert)
